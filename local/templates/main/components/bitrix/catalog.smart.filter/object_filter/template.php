...
<div class="row row_catalog_filters_fp d_flex f_wrap">
    <div class="item">
        <div class="catalog_filters_field d_flex a_items_center f_wrap">
            <div class="catalog_filters_field--txt">Тип недвижимости:</div>
    ...
    <?if(count($arItem["VALUES"])==0)continue?>
    <div class="item">
        <div class="catalog_filters_field d_flex a_items_center f_wrap">
            ...
            <div class="catalog_filters_field--field">
                ...
                <?switch ($arItem["DISPLAY_TYPE"]):
                    ...
                    <div class="catalog_filters_field--range_wrapper">
                        ...
                        <div class="catalog_filters_field--range" data-prefix="от" data-prefix2="до" data-sufix="₽" data-min="<?=$arItem["VALUES"]["MIN"]["VALUE"]?>" data-max="<?=$arItem["VALUES"]["MAX"]["VALUE"]?>" data-start="<?=$arItem["VALUES"]["MIN"]["VALUE"]?>" data-end="<?=$arItem["VALUES"]["MAX"]["VALUE"]?>"></div>
                    </div>
                    <?break;?>
                    <?case "P":?>
                    <select name="<?=$arCur["CONTROL_NAME_ALT"]?>" onchange="smartFilter.select(this)">
    ...
    <div class="catalog_filters_field--btn">
        <button type="submit" id="set_filter" class="btn btn_yellow btn--icon d_flex a_items_center j_content_center">
